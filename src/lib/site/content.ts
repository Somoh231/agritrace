 ...
 *
 * Claims policy: every capability stated here is implemented in this repository
 * (workflow engine, role/geography-scoped access, audit log, boundary capture,
 * offline queue, transfer workflow, controlled exports). No farmer, warehouse,
...
export const PRACTICES: Practice[] = [
  ...
  },
  {
    ...
    scope: ["Field boundary capture", "Boundary validation", "County and district geography", "Operational mapping"],
  ...
  },
  {
    ...
    short: "County, national, donor and executive reporting generated from approved records.",
    outcome: "Reports that can be traced back to the approved records they were built from.",
    scope: ["Executive and national reporting", "Donor and programme reporting", "Compliance reporting", "Controlled exports"],
    delivers: "Role-scoped reports produced from the operational record, not from re-keyed spreadsheets.",
...
export const PRODUCTS: Product[] = [
  {
    ...
    integrations: ["CSV import for registries and ledgers", "PDF and CSV exports", "Documented API for approved integrations"],
  ...
  },
  {
    ...
    capabilities: [
      "Registration by field officers within their assigned area",
      "Verification and eligibility decisions reserved for reviewers",
      "Provenance on every record: who registered it, where and when",
      "Duplicate-safe offline registration",
    ],
    ...
    lineage: [
      ...
      { step: "Duplicate check", actor: "Registry", status: "done", label: "Clear" },
  ...
  },
  {
    ...
    line: "Plot boundaries walked on the ground, validated, and tied to the farmer record.",
    ...
    capabilities: [
      "Walk-the-corners boundary capture with live GPS accuracy",
      "Validation that rejects crossing outlines, duplicate corners and out-of-country points",
      "Area estimation from the captured outline",
      "County and district geography for every record",
    ],
    workflow: ["Walk corners", "Validate outline", "Link to farmer", "Review on the map"],
    ...
    lineage: [
      ...
      { step: "Outline validated", actor: "Boundary checks", status: "done", label: "Valid" },
  ...
  },
  {
    ...
    line: "County, national, donor and executive reporting generated from approved records.",
    ...
    capabilities: [
      ...
      "Exports scoped to each user's role and geography",
      "Spreadsheet-safe CSV exports",
      "Reports built only from approved records",
    ],
  ...
  },
  {
    ...
    line: "Capture that keeps working without coverage and syncs once, safely, when it returns.",
    ...
    capabilities: [
      ...
      "Replay under the officer's own permissions when back online",
      "Duplicate-safe sync and removal of synced personal data from the device",
...
export const FRAGMENTS = [
  ...
  { kind: "PDF", title: "Quarterly report", issue: "Cannot be traced", resolved: "Built from approved records" },
...
export const LIBERIA = {
  ...
  components: [
    ...
    { title: "National reporting", body: "Built only from approved records." },
  ],
};
