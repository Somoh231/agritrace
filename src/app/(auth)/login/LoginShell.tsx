        ...
        >
          ...
          <div className="hidden lg:block">
            ...
            <ul className="mt-10 space-y-3 text-[1rem] text-white/75">
              {["Workspaces for each role in the programme", "Approval decisions recorded in the workflow ledger", "Field capture that queues work offline"].map((t) => (
...
export function LoginAccountNote() {
  return (
    <p className="mt-6 text-[0.9375rem] leading-relaxed text-[rgb(var(--av-slate))]">
      Accounts are created by your organisation&rsquo;s AgriVault administrator. If you cannot sign in, contact your
      administrator.
    </p>
  );
}
