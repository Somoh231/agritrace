    ...
    >
      <div className="grid gap-3 sm:grid-cols-2 xl:grid-cols-3">
        <Link href="/command-center" className={TILE_CLASS}>
          ...
          <p className="mt-1 text-slate-400">National operational posture.</p>
        </Link>
        <Link href="/national-operations" className={TILE_CLASS}>
          <div className="font-semibold text-white">National operations</div>
          <p className="mt-1 text-slate-400">Cross-programme operational view.</p>
        </Link>
        <Link href="/national-heat-map" className={TILE_CLASS}>
          <div className="font-semibold text-white">National heat map</div>
          <p className="mt-1 text-slate-400">County intelligence and signals.</p>
        </Link>
        <Link href="/food-security" className={TILE_CLASS}>
          <div className="font-semibold text-white">Food security</div>
          <p className="mt-1 text-slate-400">National visibility on food security indicators.</p>
        </Link>
        <Link href="/reports" className={TILE_CLASS}>
          <div className="font-semibold text-white">Reporting & analytics</div>
          <p className="mt-1 text-slate-400">Ministry reporting center and exports.</p>
        </Link>
        <Link href="/compliance/audit-log" className={TILE_CLASS}>
          <div className="font-semibold text-white">Audit log</div>
          <p className="mt-1 text-slate-400">Immutable trail for ministry oversight.</p>
        </Link>
      </div>
      <div className="rounded-lg border border-sky-900/40 bg-sky-950/20 px-3.5 py-2 text-[11px] text-slate-400">
        <span className="font-mono text-[9px] uppercase tracking-[0.18em] text-sky-300/90">Reporting chain</span>{" "}
