...
export default function CacWorkspacePage() {
  return (
    <MinistryPageShell
      title="CAC workspace"
      description="County Agriculture Coordinators — county verification and approval, escalation management, reporting compliance, operational coordination, and consolidation toward ministry reporting."
    ...
    >
      <div className="rounded-xl border border-amber-900/35 bg-amber-950/15 px-4 py-3 text-[12px] text-slate-300">
        ...
        <p className="mt-1 leading-relaxed">
          CLAN capture → DAO consolidation → <span className="text-white">CAC county verification</span> → Ministry aggregation.
        </p>
      </div>
