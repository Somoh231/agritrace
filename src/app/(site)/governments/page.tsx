...
const PILLARS = [
  ...
  },
  {
    ...
    body: "Workflow records carry who submitted, verified and approved them. Decisions are kept in an append-only ledger that auditors can follow.",
  },
  {
    title: "Interoperability",
    body: "Existing registries and ledgers come in through CSV import; reports go out as PDF and CSV.",
  },
  {
    title: "Continuity",
...
const CONTROL = [
  ...
  { k: "Access", v: "Access is organised by role and assigned geography, from a field officer's area to the national view." },
  { k: "Approvals", v: "Approval chains follow the institution's own administrative levels." },
