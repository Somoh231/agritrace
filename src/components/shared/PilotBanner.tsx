...
export default function PilotBanner() {
  ...
  return (
    <div className="w-full border-b border-emerald-900/40 bg-emerald-950 px-4 py-1.5">
      <div className="flex items-center gap-2 font-mono text-[11px] text-emerald-50">
