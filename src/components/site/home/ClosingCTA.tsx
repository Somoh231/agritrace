...
export default function ClosingCTA() {
  return (
    ...
    >
      ...
      <div className="avs-container flex min-h-[640px] flex-col items-center justify-center py-28 text-center md:min-h-[740px]">
        <h2 id="closing-title" className="avs-display avs-reveal max-w-[14ch] text-[clamp(2.75rem,6.6vw,6.5rem)]">
          Build stronger agricultural <span className="avs-accent">systems</span>.
        </h2>
        <p className="avs-lead avs-reveal mt-8 max-w-[38rem] text-white/85">
