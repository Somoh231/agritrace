...
export type QueueRowTone = "default" | "alert" | "escalation" | "ok";

const toneToBadge: Record<QueueRowTone, "neutral" | "danger" | "warning" | "success"> = {
  default: "neutral",
  alert: "danger",
  escalation: "warning",
  ok: "success",
...
const toneDot: Record<QueueRowTone, string> = {
...
/** Primary CTA used alongside queue panels in role workspaces. */
export function QueuePrimaryLink({ href, children }: { href: string; children: React.ReactNode }) {
  return (
...
/** Canonical operational queue/list row for review and approval surfaces. */
