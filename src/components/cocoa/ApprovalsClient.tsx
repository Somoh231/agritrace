...
export default function ApprovalsClient() {
  ...
  const load = React.useCallback(async () => {
    ...
    try {
      ...
      // No profile row: no approvals (there is no fallback role).
      if (!me) throw new Error("Your account does not have an AgriVault profile.");
      setProfile(me as Pick<Profile, "id" | "role">);
