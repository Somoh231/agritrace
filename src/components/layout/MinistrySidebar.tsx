...
function MoMark() {
  return (
    <div className="relative h-8 w-8 shrink-0 rounded-lg bg-gradient-to-br from-[#0c4a21] to-[#052e16] grid place-items-center ring-1 ring-[rgb(var(--ministry-gold))]/40 shadow-md">
      ...
      <div className="px-3 py-3.5 border-b border-white/[0.06]">
        <div className="flex items-center gap-2.5">
          ...
          <div className="min-w-0">
            <div className="font-serif-display text-[16px] leading-none text-white">
              AgriVault <span className="text-[rgb(var(--ministry-gold))]">Data</span>
            </div>
            <div className="mt-1 font-mono text-[8px] uppercase tracking-[0.16em] text-emerald-200/60">
