...
`geoBoundaries-LBR-ADM1.geojson` is the unmodified upstream file. Every
Liberia county geometry in this repository is generated from it by
`scripts/build-liberia-geo.mjs`:

- `public/data/liberia-counties.geojson` — application maps (simplified)
- `src/lib/site/liberia-geo.ts` — public-site SVG map

It replaces the previous GADM-derived geometry, whose licence does not permit
commercial use.
